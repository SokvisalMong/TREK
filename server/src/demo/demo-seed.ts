...
function seedExampleTrips(db: Database.Database, adminId: number, demoId: number): void {
  ...
  const insertAdditionalCategory = db.prepare(
  ...
  insertAdditionalCategory.run(t1pIds[3], 7); // Tsukiji: Restaurant + Bar/Cafe
  insertAdditionalCategory.run(t1pIds[4], 9); // Meiji Jingu: Attraction + Nature
  ...
  insertAdditionalCategory.run(t2pIds[0], 8); // W Barcelona: Hotel + Beach
  insertAdditionalCategory.run(t2pIds[0], 7); // W Barcelona: Hotel + Bar/Cafe
  insertAdditionalCategory.run(t2pIds[7], 2); // El Born: Bar/Cafe + Restaurant
  ...
  insertAdditionalCategory.run(t3pIds[0], 2); // Plaza: Hotel + Restaurant
  insertAdditionalCategory.run(t3pIds[2], 3); // Central Park: Nature + Attraction
  insertAdditionalCategory.run(t3pIds[9], 4); // Chelsea Market: Restaurant + Shopping
