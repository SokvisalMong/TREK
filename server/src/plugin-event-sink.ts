...
const ENTITY_SNAPSHOT: Readonly<Record<string, { key: string; fields: readonly string[] }>> = {
  ...
  budget: {
    key: 'item',
    fields: ['id', 'trip_id', 'category', 'name', 'total_price', 'persons', 'days', 'note', 'sort_order'],
  },
  ...
  file: {
    key: 'file',
    fields: ['id', 'trip_id', 'place_id', 'reservation_id', 'original_name', 'file_size', 'mime_type', 'description'],
  },
  assignment: {
    key: 'assignment',
    fields: ['id', 'day_id', 'place_id', 'order_index', 'notes', 'assignment_time', 'assignment_end_time'],
  },
  trip: {
    key: 'trip',
    fields: [
