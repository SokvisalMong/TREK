...
import { z } from 'zod';
import { additionalCategoryIdsSchema } from '@trek/shared'
...
export class AccommodationsMcp {
  ...
  async createPlaceAccommodation(
    { tripId, name, description, lat, lng, address, category_id, additional_category_ids, google_place_id, google_ftid, osm_id, place_notes, website, phone, start_day_id, end_day_id, check_in, check_in_end, check_out, confirmation, accommodation_notes, price, currency }: {
