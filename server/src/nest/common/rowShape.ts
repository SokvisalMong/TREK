import type { AssignmentRow, Tag, Participant, Category } from '../../types';
...
export function formatAssignmentWithPlace(a: AssignmentRow, tags: Partial<Tag>[], participants: Participant[], additionalCategories: Category[] = []) {
  return {
    id: a.id,
    day_id: a.day_id,
    place_id: a.place_id,
