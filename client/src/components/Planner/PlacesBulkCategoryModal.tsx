...
/**
 * Bulk category editor. Primary changes apply one visual category immediately;
 * additional changes replace the complete shared classification set on Apply.
 */
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <p className="text-content-faint" style={{ fontSize: 12, marginBottom: 12 }}>
          ...
          {(['primary', 'additional'] as const).map((option) => (
            <button
              ...
              style={{
                ...
                fontSize: 12,
                fontWeight: 600,
                boxShadow: mode === option ? '0 1px 3px rgba(0,0,0,.08)' : 'none',
              }}
            >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 2, maxHeight: 300, overflowY: 'auto' }}>
          ...
          {mode === 'primary' && (
            <button
              ...
              style={{
                ...rowStyle,
                borderTop: categories.length > 0 ? '1px solid var(--border-faint)' : 'none',
                marginTop: categories.length > 0 ? 2 : 0,
              }}
              onMouseEnter={hoverOn}
              onMouseLeave={hoverOff}
            >
        ...
        {mode === 'additional' && (
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: 8, marginTop: 14 }}>
            ...
            <button
              type="button"
              onClick={() => onPickAdditional(additionalCategoryIds)}
