import { isUncategorizedPlace } from '@trek/shared';
...
export function PlacesDropOverlay({ t }: SidebarState) {
  return (
    ...
    >
      ...
      <span className="text-accent" style={{ fontSize: 'calc(13px * var(--fs-scale-body, 1))', fontWeight: 600 }}>
            ...
            <div style={{ marginTop: 6, position: 'relative', display: 'flex', gap: 6, alignItems: 'stretch' }}>
              ...
              {catDropOpen && (
                ...
                >
                  ...
                  {places.some(isUncategorizedPlace) &&
                    (() => {
