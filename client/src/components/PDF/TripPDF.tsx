...
export async function downloadTripPDF({
  ...
  const pluginSections = await pluginsApi
    .pdfSections(trip.id)
    .then((r) => r.sections || [])
    .catch(() => []);
        ...
        merged.length === 0
          ...
          : merged
              ...
              <div class="note-card">
                ...
                const additionalCategoryNames = (place.additional_categories ?? [])
            ...
            <div class="place-card">
              ...
              <div class="place-info">
                ...
                ${additionalCategoryNames ? `<div class="info-row"><span class="info-spacer"></span><span class="info-text muted">${escHtml(tr('places.formAdditionalCategories'))}: ${escHtml(additionalCategoryNames)}</span></div>` : ''}
