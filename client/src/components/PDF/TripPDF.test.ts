...
const placeWithDetails = {
  ...
  additional_categories: [{ id: 7, name: 'History', color: '#92400e', icon: 'museum' }],
  price: '15',
  image_url: null,
...
describe('downloadTripPDF', () => {
  ...
  it('FE-COMP-TRIPPDF-011: renders place cards with name, address and category badge', async () => {
    ...
    expect(iframe!.srcdoc).toContain('History');
  });
      ...
      assignments: {
        '10': [
          { ...assignmentForDay, place: { ...placeWithDetails, currency: 'USD', price: '273' } },
          {
            ...assignmentForDay,
            id: 201,
            place: { ...placeWithDetails, id: 101, name: 'Museum', currency: null, price: '2500' },
          },
        ],
      } as any,
    };
