          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5">
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-[12px] font-medium border transition-colors ${categoryId == null ? 'bg-inverse text-inverse-text border-transparent' : 'bg-surface-card text-content-secondary border-edge hover:bg-surface-hover'}`}
              >
              ...
              {categories.map(cat => {
                ...
                return (
                  <button
                    ...
                    style={selected ? { color, background: `color-mix(in oklch, ${color} 15%, transparent)`, borderColor: `color-mix(in oklch, ${color} 40%, transparent)` } : undefined}
                  >
            ...
            <label className="block text-[12px] font-medium text-content-secondary mb-1.5 mt-3">
