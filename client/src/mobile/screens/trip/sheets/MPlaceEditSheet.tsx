  ...
  useEffect(() => {
    ...
    if (editingPlace) {
      ...
      setForm({
        ...
        additional_category_ids: editingPlace.additional_category_ids ?? [],
        ...
        <PlCategoryPicker
          ...
          onChange={(id) =>
            setForm((prev) => ({
              ...prev,
              category_id: id,
              additional_category_ids: prev.additional_category_ids.filter((categoryId) => String(categoryId) !== id),
            }))
          }
          additionalCategoryIds={form.additional_category_ids}
          onAdditionalChange={(ids) => setForm((prev) => ({ ...prev, additional_category_ids: ids }))}
        />
