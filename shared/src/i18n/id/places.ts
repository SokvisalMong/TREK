...
const places: TranslationStrings = {
  ...
  'places.formAdditionalCategories': 'Additional categories', // en-fallback
  'places.addAdditionalCategory': 'Add another category', // en-fallback
  'places.removeAdditionalCategory': 'Remove {name}', // en-fallback
  'places.primaryCategory': 'Primary category', // en-fallback
