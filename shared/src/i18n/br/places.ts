...
const places: TranslationStrings = {
  ...
  'places.formAdditionalCategories': 'Categorias adicionais',
  'places.addAdditionalCategory': 'Adicionar outra categoria',
  'places.removeAdditionalCategory': 'Remover {name}',
